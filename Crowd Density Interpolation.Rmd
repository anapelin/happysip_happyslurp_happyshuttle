...
tm_shape(base_map) + tm_borders(col='black') + tm_fill(col = "white") +
  tm_shape(bcr_spatial) + tm_dots(size = 0.5, col = 'cat', palette = c('blue','green2'), title = 'Category') + # Nightlife and Restaurants locations
...
l_1 <- tm_shape(r.m) + 
  ...
  tm_shape(bcr) + tm_dots(size=0.1, col = 'cat', palette = c('blue','green2'), title = 'Category') +
