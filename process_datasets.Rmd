...
# 2.3 Restaurants 
restaurants <- read.csv("dataset/grab.csv") %>% select(name, address, lat, lon)
...
```{r}
st_write(nightlife_filtered_sf, "dataset/processed_datasets/nightlife_locations.geojson", append=FALSE)
st_write(restaurant_filtered_sf, "dataset/processed_datasets/restaurants.geojson", append=FALSE)
```
